...
@EndUserText.label: 'PR Actual Period'
...
define view entity ZMIIFI_PR_ACTUAL_PERIOD
  with parameters
    P_CompanyCode : bukrs,
    P_Period      : fins_fiscalperiod,
    P_FiscalYear  : fis_gjahr_no_conv
//    P_GLAccount   : saknr
  as select from Z_I_PR_ACTUAL_PERIOD(
...
//                 P_GLAccount: $parameters.P_GLAccount ) as PrActual
    left outer join   Z_I_PO_ACTUAL_PERIOD(
                 P_CompanyCode: $parameters.P_CompanyCode,
                 P_Period: $parameters.P_Period,
